 ...
 * ***** END LICENSE BLOCK ***** */
//
// Downloaded from http://davy.landman.googlepages.com/MurmurHash2.cs
// Couple of edits are made by Mikalai Shurkaeu on 2022-10-27 in order to let this code compile.
// All of the edits are marked with "Mikalai Shurkaeu. [Added|Edited] line"
...
namespace HashTableHashing
{
	public class MurmurHash2Simple : ISeededHashAlgorithm
	{
		...
		{
			if (data == null) throw new ArgumentNullException(nameof(data)); //Mikalai Shurkaeu. Added line. To satisfy CA1062
...
/* Mikalai Shurkaeu. Added line. Commented because usage of "unsafe" doesn't allow to compile code with my settings
